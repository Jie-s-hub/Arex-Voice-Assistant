...
- A FastAPI PC server using the OpenAI Audio and Responses APIs, deterministic safety-critical home-command recognition, structured AI output, and PCM speech streaming.
